...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Create Workouts
        octo_models.Workout.objects.create(name='Morning Cardio', description='A quick morning run', duration=30)
        octo_models.Workout.objects.create(name='Strength Training', description='Weights and resistance', duration=45)
